...
from cfn_resource.utils import (
    JsonFormatter,
    _serialize,
...
class TestUtils(unittest.TestCase):
    ...
    def test_logging_json_keys(self):
        ...
        self.assertEqual(
            ["timestamp", "level", "location", "RequestType", "message"],
            list(logs.keys()),
        )
    ...
    def test_serialize(self):
        ...
        method_wrapper_str_prefix = (
            "<method-wrapper '__init__' of TestClassSerialize object at "
        )
