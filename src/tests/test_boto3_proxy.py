...
from cfn_resource.boto3_proxy import (
    Boto3Client,
    Boto3SessionProxy,
    boto3_factory,
    get_boto3_proxy_session,
...
class TestBoto3Client(unittest.TestCase):
    ...
    def test_client(self, mock_boto):
        ...
        self.assertEqual(("some-service",), call[1])
...
class TestBoto3funcs(unittest.TestCase):
    ...
    def test_boto3_factory(self):
        ...
        # proxy checks for public methods to discover supported aws api's, in this
        # case it's the Mock instance's methods
...
class TestBoto3SessionProxy(unittest.TestCase):
    def test_proxy_(self):
        ...
        sess_proxy = Boto3SessionProxy(
            "us-east-2", boto3_factory(mock_provider, MockSession), MockSession
        )
