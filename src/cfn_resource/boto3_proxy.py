...
def get_boto3_proxy_session(session_config, boto3pkg=boto3):
    ...
    return Boto3SessionProxy(session_config['region_name'], boto3_factory(get_config), boto3pkg)
    ...
    class Boto3Proxy:
        ...
        def __init__(self, boto3_type, service_name, region_name):
            ...
            for boto3_method in self._get_boto3_methods(service_name, region_name):
                api_wrapper = partial(self._wrapper, service_name=service_name, region_name=region_name,
        ...
        def _wrapper(self, service_name, region_name, boto3_method, **kwargs):
            ...
            boto3_instance = getattr(session, self._boto3_type)(service_name, region_name=region_name)
        ...
        def _get_boto3_methods(self, service_name, region_name):
            f = getattr(boto3pkg, self._boto3_type)(service_name, aws_access_key_id='', aws_secret_access_key='',
